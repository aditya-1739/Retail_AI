...
from app.schemas import FaceRecognitionResult
...
@router.post(
    ...
    description="Allows registered users to upload a photo of a face to classify and recognize the person ID.",
...
async def recognize(
    ...
    db_history = models.PredictionHistory(
        ...
        file_size=file_size,
        result_category=str(result["person_id"]),
